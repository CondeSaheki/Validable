...
namespace nimiat
{
    template<typename _type = bool> class validable  // must be default construtible and have assing operator removed due to gcc bug
	{
	public: // type
		using type = _type;
	private: // data
	...
	public: // functions
		[[nodiscard]] constexpr bool is_valid() noexcept { return _valid; }
